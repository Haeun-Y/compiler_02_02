...
7. integer scalar const
8. integer array const
9. not defined identifier or function
...
void PrintHStable()
{
    ...
    for (int i = 0; i < HTsize; i++)
    {
        ...
        for (HTpointer cur = HT[i]; cur != NULL; cur = cur->next)
        {
            ...
            case 7: printf(": integer scalar const, "); break;
            case 8: printf(": integer array const, "); break;
            case 9: printf(": not defined identifier or function "); break;
